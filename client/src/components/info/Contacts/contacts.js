    ...
    <>
      <div className="contacts">
        <div className="contacts__document">
          <h2>Контакты:</h2>
          <p>
            Фактический адрес: 353380, РОССИЯ, КРАСНОДАРСКИЙ КРАЙ, Г. КРЫМСК,
            УЛ. ДЕМЬЯНА БЕДНОГО 19Б
          </p>
          ...
          <p>
            Юридический адрес: 353380, РОССИЯ, КРАСНОДАРСКИЙ КРАЙ, Г. КРЫМСК,
            УЛ. ДЕМЬЯНА БЕДНОГО 19Б
          </p>
        ...
        <Link to="/">
          <button className="contacts__to-main-page">На главную</button>
        </Link>
      </div>
    </>
  );
