    ...
    <>
      <div className="conf">
        <div className="conf__document">
          ...
          <h2>Защита данных </h2>
          <p>
            Администрация сайта www.amdelivery.ru (далее Сайт) не может передать
            или раскрыть информацию, предоставленную пользователем (далее
        ...
        <Link to="/">
          <button className="conf__to-main-page">На главную</button>
        </Link>
      </div>
    </>
  );
